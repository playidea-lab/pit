...
const ROLES = [
  ...
  {
    title: "팀원",
    steps: ["초대 링크를 누르고 회사 이메일이나 GitHub로 로그인한다", "쓰는 도구(Claude Code · claude.ai · Codex)에 주소 하나를 붙인다", "평소처럼 일한다"],
    cta: ["연결하기", "/connect"],
  },
] as const;
...
const POINTS = [
  ...
  ["3일 동안은 당신 것입니다", "팀에서 기록된 판단은 3일 뒤 팀에 보입니다. 그 전에 정리함에서 빼거나 고칠 수 있습니다."],
